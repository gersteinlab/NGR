...
def main():
    ...
    ngr_scores = ngr.run(Y=initial_scores['score'], W=ppi_matrix, W_index=ppi_matrix_index) # ngr_scores have the order of original initial scores (as passed to this function which matches matrix index order)
