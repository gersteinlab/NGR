...
other_methods_files <- Dict$new(all = paste(other_methods_lists_dir, c("nCOP", "HHotNet-paper"), "_all_list.csv", sep=""),
                                BRCA = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING", "Ruffalo", "TIEDIE-linkers-Fig4", "TIEDIE-linkers-Fig5"), "_BRCA_list.csv", sep=""),
                                CESC = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-HumanNetv2", "HHotNet-all-nonsingleton-clusters-HumanNetv2"), "_CESC_list.csv", sep=""),
                                CHOL= paste(other_methods_lists_dir, c(""), "_CHOL_list.csv", sep=""),
                                COAD = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-HumanNetv2", "HHotNet-all-nonsingleton-clusters-HumanNetv2"), "_COAD_list.csv", sep=""),
                                ESCA = paste(other_methods_lists_dir, c("HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING", "HHotNet-consensus"), "_ESCA_list.csv", sep=""),
                                HNSC = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING"), "_HNSC_list.csv", sep=""),
                                KICH = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING"), "_KICH_list.csv", sep=""),
                                KIRC = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING", "HHotNet-consensus"), "_KIRC_list.csv", sep=""),
                                KIRP = paste(other_methods_lists_dir, c("nCOP"), "_KIRP_list.csv", sep=""),
                                LIHC = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING", "HHotNet-consensus"), "_LIHC_list.csv", sep=""),
                                LUAD = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING", "HHotNet-consensus"), "_LUAD_list.csv", sep=""),
                                LUSC = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING", "HHotNet-consensus"), "_LUSC_list.csv", sep=""),
                                PRAD = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-HumanNetv2", "HHotNet-all-nonsingleton-clusters-HumanNetv2"), "_PRAD_list.csv", sep=""),
                                READ = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-HumanNetv2", "HHotNet-all-nonsingleton-clusters-HumanNetv2"), "_READ_list.csv", sep=""),
                                STAD = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING"), "_STAD_list.csv", sep=""),
                                THCA = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-STRING", "HHotNet-all-nonsingleton-clusters-STRING"), "_THCA_list.csv", sep=""),
                                UCEC = paste(other_methods_lists_dir, c("nCOP", "HHotNet-largest-cluster-HumanNetv2", "HHotNet-all-nonsingleton-clusters-HumanNetv2"), "_UCEC_list.csv", sep="")) # READ nCOP has 0 genes after filtering Bailey et al genes out so it was removed
```
...
cancer_types <- c('all', 'BRCA', 'CESC', 'COAD', 'ESCA', 'HNSC', 'KICH', 'KIRC', 'KIRP', 'LIHC', 'LUAD', 'LUSC', 'PRAD', 'READ', 'STAD', 'THCA', 'UCEC') # no other lists available for CHOL
...
results$Method <- factor(results$Method, levels=c('NGR', 'HHotNet-consensus', 'HHotNet-LC', 'HHotNet-all', 'nCOP')) # reorder legend labels
...
yaxis_label <- c('Mean DepMap Score (LogFC)', 'Cell Lines with \n -ve DepMap Score (%)')
...
for(i in 1:length(Metric_values)){
  ...
  plots[[i]] <- (ggplot(temp_results, aes(fill=Method, width=0.75)) + 
    ...
    xlab('') +
    ylab(yaxis_label[i]) +
    scale_fill_manual(values = c('NGR' = 'darkgreen', 'HHotNet-consensus' = 'navyblue', 'HHotNet-LC' = 'blue2', 'HHotNet-all' = 'skyblue1', 'nCOP' = 'burlywood2')) +
