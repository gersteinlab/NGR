...
```{r}
# discretize matrix (raw values of 1 remains as is; raw values v > 1: (a) normalized v < normalized 50th percentile -> 1 (b) 50th percentile < normalized v <= 75th percentile -> 2; 75th percentile < normalized v <= 90th percentile -> 3; 90th percentile < normalized v -> 4)
