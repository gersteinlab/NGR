...
for f in annovar/results/*_varpergene* 
do 
...
for f in annovar/results/*_samplepergene* 
do 
	awk -f normalize_subscores_by_gene_length.awk pass=1 annovar/GRCh37_bioMart_bioConductor_package_all_121819.txt pass=2 $f
	echo $f " normalized successfully."
done
...
for f in annovar/results/*_synonymous* 
do 
	awk -f normalize_subscores_by_gene_length.awk pass=1 annovar/GRCh37_bioMart_bioConductor_package_all_121819.txt pass=2 $f
	echo $f " normalized successfully."
done
...
for f in annovar/results/*_nonsynonymous* 
do 
	awk -f normalize_subscores_by_gene_length.awk pass=1 annovar/GRCh37_bioMart_bioConductor_package_all_121819.txt pass=2 $f
	echo $f " normalized successfully."
done
...
for f in annovar/results/*_stopgain* 
do 
	awk -f normalize_subscores_by_gene_length.awk pass=1 annovar/GRCh37_bioMart_bioConductor_package_all_121819.txt pass=2 $f
	echo $f " normalized successfully."
done
...
for f in annovar/results/*_frameshift_substitution* 
do 
	awk -f normalize_subscores_by_gene_length.awk pass=1 annovar/GRCh37_bioMart_bioConductor_package_all_121819.txt pass=2 $f
	echo $f " normalized successfully."
done
