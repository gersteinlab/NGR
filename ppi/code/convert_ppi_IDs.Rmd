...
network_names <- c('HumanNetv2', 'STRING')
network_files <- paste('../', c('HumanNetv2-FunctionalGeneNetwork_[FN]_top_10perc_edges.tsv', 'STRING_9606.protein.links.notextmining.nodatabase.edgescore.800upwards.v11.0.txt'), sep='')
